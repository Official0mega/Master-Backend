    ...
    if request.method == "POST":
        if "signup_post" in request.POST:
            ...
            if pswd != pswd2:
                ...
                otp_purpose = "signup"
                send_mail(
                    "CodeVerse-Password-Manager Password Manager: Confirm Email",
            ...
            if input_otp != global_code:
                ...
                if(otp_purpose=="signup"):
                    ...
                    if not new_user==None:
                        ...
                        msg = f"{new_user_data[0]}. Thanks for registering with CodeVerse."
                        msg_page_data = {
                            "text":msg, 
                            "code":True, 
                        }
                        link = "https://hilarious-gold-walrus.cyclic.app/"
                        message = format_html(
                            "Your account was Successfully Created.<br> Website Link -> <a href='{}'>hilarious-gold-walrus.cyclic.app/</a>", link
                        )
                        send_mail(
                        "Welcome to CodeVerse-Password-Manager.",
                        message,
                        settings.EMAIL_HOST_USER,
                        [new_user_data[1]],
                        fail_silently=False,
            ...
            if new_user is None:
                ...
                otp_purpose = "login"
                send_mail(
                    " Password Manager: Confirm Login",
            ...
            if not User.objects.filter(email=email).exists():
                ...
                send_mail(
                    "CodeVerse-Password-Manager Password Manager: Passsword Reset",
            ...
            send_mail(
                "CodeVerse-Password-Manager Password Manager: Account Delete",
